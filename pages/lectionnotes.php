...
$sql_1 = "SELECT * FROM lection WHERE lection_id = $lectionid;";
...
<body>
  ...
  <section class="main-2">
      <div class="big-notebox">
        <h1 class="heading-primary">
            Quick notes
        </h1>
        <form action="" method="post" class="form">
        <textarea name="textinput" cols="30" rows="10"></textarea>
      </div>
      <button type="submit" name="submit" class="btn-tertiary">Save</button>
      </form>
  </section>

  <nav class="navigation-2">
    <ul class="navigation__list-2">
        <li class="navigation__item-2  left"><a class="link" <?php echo "href='lection.php?ID=$lectionid'"; ?>>Video</a></li>
        <li class="navigation__item-2 active"><a class="link active" <?php echo "href='lectionnotes.php?ID=$lectionid'"; ?>>Notes</a></li>
        <li class="navigation__item-2"><a class="link" <?php echo "href='lectiontest.php?ID=$lectionid'"; ?>>Test</a></li>
        <li class="navigation__item-2 right"><a class="link" <?php echo "href='lectiontask.php?ID=$lectionid'"; ?>>Task</a></li>
    </ul>
  </nav>

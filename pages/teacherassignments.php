...
$id = $_GET["ID"];
 ...
 <html lang="nb">
   <head>
     ...
     <meta charset="UTF-8">
     <link rel="stylesheet" href="../CSS/teacherassignments.css">
...
<section class="main">
  ...
  <nav class="navigation-left">
    <div class="navigation-left__container">
      <ul class="navigation-left__list">
        ...
        <li class="navigation-left__item"><?php echo "<a  href='teacherassignments.php?ID=$id' class='navigation-left__link active'>";?>Assignments</a></li>
  ...
  <div class="right-side">
      <div class="assignmentsbuttons">
          <a href="#popup" class="btn active">New assignment +</a>

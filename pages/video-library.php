...
<head>
    <title>Reekap</title>
    <meta charset="UTF-8">
    <link rel="stylesheet" href="../CSS/video-library.css">
  ...
  <section class="main">
    ...
    <div class="navigation-left__container">
      <ul class="navigation-left__list">
        ...
        <li class="navigation-left__item"><?php echo "<a  href='video-library.php?ID=$id' class='navigation-left__link active'>";?>Video-library</a></li>
